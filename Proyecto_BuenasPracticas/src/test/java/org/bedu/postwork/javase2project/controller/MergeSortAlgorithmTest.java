...
import org.bedu.postwork.javase2project.controller.MergeSortAlgorithm;
...
class MergeSortAlgorithmTest {
    ...
    // CHECKLIST:  La prueba MergeSortAlgorithmTest genera y agreguen
    // cien mil números aleatorios a una lista.
    ...
    // CHECKLIST: Existen dos test para ejecutar los dos tipos de sort creados
    // en la clase MergeSortAlgorithm.
    @Test
    @DisplayName("Postwork 06: Ordena una colección de enteros")
    ...
    @Test
    @DisplayName("Postwork 06: Ordena una colección con un comparador")
